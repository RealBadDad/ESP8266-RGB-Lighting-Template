This is a addressable RGB lightig template to provide a number of features to control an addressable RGB Lighting project from WEB interface, using an ESP8266 NodeMCU
The project ha the following features:
